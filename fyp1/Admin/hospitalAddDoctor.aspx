<%@ Page Title="Add Doctor" Language="C#" MasterPageFile="~/Admin/adminSideBar.Master" AutoEventWireup="true" CodeBehind="hospitalAddDoctor.aspx.cs" Inherits="fyp1.Admin.hospitalAddDoctor" %>
            ...
            <div class="mb-2">
                <div class="d-flex">
                    ...
                    <asp:LinkButton CssClass="btn btn-primary fw-bold"
                        ID="btnConfirmAddDoctor" runat="server" OnClick="btnConfirmAddDoctor_Click">
                    Add Doctor
                    </asp:LinkButton>
                </div>
            </div>
                ...
                <div class="card-body p-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <asp:TextBox ID="txtRole" runat="server" CssClass="form-control" PlaceHolder="Doctor" ReadOnly="true"></asp:TextBox>
                        </div>
                        <div class="col-md-4 mb-3">
