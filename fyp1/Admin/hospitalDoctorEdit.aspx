        ...
        <div class="col-xxl-12 col-lg-12">
            <div class="mb-2">
                <div class="d-flex">
                    ...
                    <asp:LinkButton CssClass="btn btn-primary fw-bold"
                        ID="btnConfirmEditDoctor" runat="server" OnClick="btnConfirmEditDoctor_Click"
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-body p-3">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label for="ddlPrimaryDepartment" class="form-label">First Department</label>
                            <div class="d-flex position-relative">
                                <asp:DropDownList ID="ddlPrimaryDepartment" runat="server" CssClass="form-control">
                                    <asp:ListItem Text="- Select -" Value=""></asp:ListItem>
                                </asp:DropDownList>
                                <i class="bi bi-chevron-down dropdown-icon"></i>
                            </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="ddlSecondaryDepartment" class="form-label">Second Department</label>
                            <div class="d-flex position-relative">
                                <asp:DropDownList ID="ddlSecondaryDepartment" runat="server" CssClass="form-control">
                                    <asp:ListItem Text="- Select -" Value=""></asp:ListItem>
                                </asp:DropDownList>
                                <i class="bi bi-chevron-down dropdown-icon"></i>
                            </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <asp:TextBox ID="txtRole" runat="server" CssClass="form-control" Text="Doctor" Value="Doctor" ReadOnly="true"></asp:TextBox>
                        </div>
                        <div class="col-md-4 mb-3">
