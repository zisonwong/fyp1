<%@ Page Title="Nurse Details" Language="C#" MasterPageFile="~/Admin/adminSideBar.Master" AutoEventWireup="true" CodeBehind="hospitalNurseDetails.aspx.cs" Inherits="fyp1.Admin.hospitalNurseDetails" %>
     ...
     <div class="col-xxl-12 col-lg-12">
         <div class="mb-2">
             <div class="d-flex">
                 <div class="me-auto">
                     <h3>
                         <asp:Label ID="lblNurseName" runat="server" Text="Label" /></h3>
                 </div>
         ...
         <div class="card border-0 shadow mb-4">
             <div class="card-body p-3">
                 ...
                 <div class="row">
                     <div class="col-md-4 mb-3">
                         <label for="txtBranchId" class="form-label">Branch</label>
                         <asp:TextBox ID="txtBranchId" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                     </div>
                     <div class="col-md-4 mb-3">
