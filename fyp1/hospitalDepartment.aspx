<%@ Page Title="" Language="C#" MasterPageFile="~/adminSideBar.Master" AutoEventWireup="true" CodeBehind="hospitalDepartment.aspx.cs" Inherits="fyp1.hospitalDepartment" %>
        ...
        <div class="col-xxl-12 col-lg-12">
            ...
            <div class="mt-5 d-flex">
                ...
                <div class="d-flex py-2">
                    <asp:DropDownList ID="ddlFilterBranchName" OnSelectedIndexChanged="ddlFilterBranchName_SelectedIndexChanged" 
                        ...
                        0 24-10.7 24-24s-10.7-24-24-24L88 64z"/></svg>
                            ...
                            <InsertItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox CssClass="px-2 w-75" ID="txtDepartmentName" runat="server"></asp:TextBox></td>
                                    <td>
                                        <asp:DropDownList ID="ddlAssignToBranch" CssClass="px-2" AutoPostBack="true" 
                            ...
                            <EditItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox CssClass="px-2 w-75" ID="txtEditDepartmentName" runat="server" Text='<%# Eval("name") %>'></asp:TextBox></td>
                                    <td>
                                        <asp:DropDownList CssClass="px-2" ID="ddlEditAssignToBranch" AutoPostBack="true" 
                                            OnSelectedIndexChanged="ddlAssignToBranch_SelectedIndexChanged" runat="server">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
