<%@ Page Title="" Language="C#" MasterPageFile="~/adminSideBar.Master" AutoEventWireup="true" CodeBehind="hospitalDoctor.aspx.cs" Inherits="fyp1.hospitalDoctor" %>
                    ...
                    <div class="col-md-4 col-lg-3 mb-4">
                        <asp:LinkButton ID="lbDoctorDetails" runat="server" CssClass="card shadow-sm staff-card rounded"
                            ...
                            <div class="card-body text-center">
                                ...
                                <asp:Button ID="btnDelete" CssClass="btn btn-outline-danger btn-sm mt-2 me-1" runat="server" Text="Delete"
                                    CommandArgument='<%# Eval("doctorID") %>' OnCommand="btnDelete_Command"
                                    OnClientClick="return confirm('Are you sure you want to delete this record?');" />
                                <asp:Button ID="btnEdit" CssClass="btn btn-outline-success btn-sm mt-2 ms-1" runat="server" Text="Edit"
